...
Partial Class Login
    ...
    Protected Sub btnLogin_Click(sender As Object, e As System.EventArgs) Handles btnLogin.Click
        ...
        If IsValid Then
            ...
            ElseIf Me.txtUsername.Text = "username" And Me.txtPassword.Text = "password" Then
                Me.Response.Redirect("~/Employee.aspx")
            Else
                Me.lblLoginAttempts.Visible = True
                Me.lblLoginAttempts.Text = System.Convert.ToString(System.Convert.ToInt32(Me.lblLoginAttempts.Text) + 1)
                If System.Convert.ToInt32(Me.lblLoginAttempts.Text) < 3 Then
                    Me.lblMessage.Text = "Invalid username/password!  Failed login attempt #: " & Me.lblLoginAttempts.Text & _
                        " of (3) allowed attempts."
                Else
                    Me.btnLogin.Enabled = False
                    Me.lblMessage.Text = "Login not allowed.  Too many failed login attempts."
                End If
                Me.lblLoginAttempts.Visible = False
            End If
