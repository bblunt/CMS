...
<head runat="server">
    <title>Consumables Management System - Summary</title>
</head>
<body>
    ...
    <asp:Image ID="imgBanner" runat="server" ImageUrl="~/Images/Banner.png" />
        ...
        <asp:SqlDataSource ID="dsSummary" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:Parameter Name="NeedsOrdering" Type="String" DefaultValue="T" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="dsNeedsOrdering" runat="server" 
            ...
            <SelectParameters>
                <asp:Parameter Name="LOCATION_ID" Type="Int32" DefaultValue="0" />
                <asp:Parameter Name="ACTIVE" Type="String" DefaultValue="Y" />
                <asp:Parameter Name="NeedsOrdering" Type="String" DefaultValue="Y" />
            </SelectParameters>
        </asp:SqlDataSource>
    </center>
    </div>
